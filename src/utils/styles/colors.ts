export const PRIMARY = '#48466d';
export const SECONDARY = '#3f72af';
export const THIRDY = '#1fab89';
export const FOURTY = '#ff2e63';
export const FIFTY = '#ffffff';
...
export const BLUE_PRIMARY = PRIMARY;
export const BLUE_SECONDARY = SECONDARY;
export const GREEN_PRIMARY = THIRDY;
